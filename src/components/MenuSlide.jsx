  ...
  return !isClient ? (
    ...
    <div className="px-5 py-8 lg:px-72 lg:py-10">
      ...
      >
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0001.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0002.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0003.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0004.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0005.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0006.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0007.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
        ...
        <SwiperSlide>
          <Image
            src="/lunch/menulunch_page-0008.jpg"
            alt="menu lunch le salama"
            width={1000}
            height={1000}
            className="w-full h-full"
